...
void test02() {
    ...
    // 插入
    L3.insert(L3.begin(), 9999);
    printList(L3); // 9999 300 100 10 30

    // remove(elem);//删除容器中所有与elem值匹配的元素。
    L3.push_back(22); // 9999 300 100 10 30 10
    L3.remove(22);    //参数 直接放值
    printList(L3);    // 9999 300 100  30
}
