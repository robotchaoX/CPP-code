...
![2016-07-01\_182727](media/image8.png){width="4.320138888888889in" height="2.9618055555555554in"}

#### 4.3.4.2 深拷贝 {#深拷贝 .15}

当类中有指针，并且此指针有动态分配空间，析构函数做了释放处理，往往需要自定义拷贝构造函数，自行给指针动态分配空间，深拷贝。

![2016-07-01\_183013](media/image9.png){width="4.569444444444445in" height="2.870138888888889in"}
...
![2016-07-18\_040751](media/image10.png){width="4.283333333333333in" height="1.4680555555555554in"}
...
![IMG\_256](media/image11.jpeg){width="5.875694444444444in" height="1.6180555555555556in"}
...
>
> ![2016-05-10\_213705](media/image12.png){width="3.423611111111111in" height="1.6527777777777777in"}
>
...
| > **c++编译器对普通成员函数的内部处理**                                                            |
+----------------------------------------------------------------------------------------------------+
| ![2016-04-12\_010344](media/image13.png){width="6.784027777777778in" height="3.566666666666667in"} |
+----------------------------------------------------------------------------------------------------+
...
![C:\\Users\\MikeJiang\\Desktop\\2016-05-10\_180446.png2016-05-10\_180446](media/image14.png){width="5.347222222222222in" height="2.8652777777777776in"}
...
|                                                                                                                                                                              |
| ![2016-07-12\_132032](media/image15.png){width="4.8069444444444445in" height="1.867361111111111in"}                                                                          |
|                                                                                                                                                                              |
...
![2016-05-06\_153655](media/image16.png){width="5.4215277777777775in" height="1.3944444444444444in"}
...
| {                                                                                 |
|                                                                                   |
| int newsize = this-\>m\_Size + *strlen*(str) + 1;                                 |
|                                                                                   |
...
| {                                                                                 |
|                                                                                   |
| int newsize = this-\>m\_Size + str.m\_Size + 1;                                   |
|                                                                                   |
| char \*temp = new char\[newsize\];                                                |
|                                                                                   |
| *memset*(temp, 0, newsize);                                                       |
...
| {                                                                                 |
|                                                                                   |
| if (*strcmp*(this-\>pString, str) == 0 && *strlen*(str) == this-\>m\_Size){       |
|                                                                                   |
| return true;                                                                      |
|                                                                                   |
| }                                                                                 |
...
| {                                                                                 |
|                                                                                   |
| if (*strcmp*(this-\>pString, str.pString) == 0 && str.m\_Size == this-\>m\_Size){ |
|                                                                                   |
| return true;                                                                      |
|                                                                                   |
| }                                                                                 |
...
![图片1](media/image17.png){width="4.321527777777778in" height="1.3819444444444444in"}

![2016-05-06\_124909\_副本](media/image18.png){width="3.9090277777777778in" height="2.8430555555555554in"}
...
![类图](media/image19.jpeg){width="2.9895833333333335in" height="2.9in"}
...
![派生类访问权限总结\_副本](media/image20.png){width="4.277083333333334in" height="2.4923611111111112in"}

![C:\\Users\\MikeJiang\\Desktop\\图片1.png图片1](media/image21.png){width="6.0375in" height="4.254861111111111in"}
...
![2016-05-06\_164314](media/image22.png){width="4.103472222222222in" height="1.6541666666666666in"}
...
> ![2016-05-06\_165258](media/image23.png){width="4.23125in" height="1.3618055555555555in"}
...
![IMG\_256](media/image24.png){width="3.8020833333333335in" height="1.9479166666666667in"}
...
>
> ![IMG\_256](media/image25.jpeg){width="4.365277777777778in" height="3.563888888888889in"}
...
----------- ------------------------------------------------------------------------------------------------------ ------------------------------------------------------------------------------------------------------
              普通继承                                                                                               虚继承
  BigBase：   ![2016-07-13\_164109](media/image26.png){width="2.6125in" height="0.875in"}                            ![2016-07-13\_164109](media/image26.png){width="2.24375in" height="0.7638888888888888in"}
  Base1：     ![2016-07-13\_164406](media/image27.png){width="2.6069444444444443in" height="0.8520833333333333in"}   ![2016-07-13\_165703](media/image28.png){width="2.4138888888888888in" height="1.4541666666666666in"}
  Base2：     ![2016-07-13\_164452](media/image29.png){width="2.482638888888889in" height="0.8020833333333334in"}    ![2016-07-13\_165758](media/image30.png){width="2.4881944444444444in" height="1.5270833333333333in"}
  Derived：   ![2016-07-13\_165703](media/image28.png){width="2.6458333333333335in" height="1.5951388888888889in"}   ![2016-07-13\_165924](media/image31.png){width="2.8097222222222222in" height="2.626388888888889in"}
----------- ------------------------------------------------------------------------------------------------------ ------------------------------------------------------------------------------------------------------
...
![ClassDiagram1](media/image32.jpeg){width="3.207638888888889in" height="2.3333333333333335in"}

![2016-07-07\_193353](media/image33.png){width="5.374305555555556in" height="3.5722222222222224in"}
...
![ClassDiagram1](media/image34.jpeg){width="3.207638888888889in" height="2.3333333333333335in"}

![2016-07-07\_195635](media/image35.png){width="5.384722222222222in" height="3.5722222222222224in"}
...
![2016-07-07\_204741](media/image36.png){width="5.7652777777777775in" height="4.01875in"}
